...
### Fixed
- Fix `_get_xattr_map` following dangling symlinks when reading xattrs, which broke `CramfsUnpacker` and `ExtPacker` ([#759](https://github.com/redballoonsecurity/ofrak/pull/759))
